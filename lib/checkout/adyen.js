...
const debug = require('debug')('checkout:adyen');
...
export function factory (options) {
  return new Adyen(Object.assign({}, options, { checkout: this }));
}
...
class Adyen extends Emitter {
  ...
  */
  start (opts) {
    ...
    const frame = this.checkout.Frame({ height: 600, path: '/adyen/start', payload });
