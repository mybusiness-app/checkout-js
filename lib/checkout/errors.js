...
const BASE_URL = 'https://dev.mybusinessapp.co.za/docs/checkout-js-';
const GOOGLE_PAY_ERRORS = [
  {
    code: 'google-pay-factory-only',
    message: 'Google Pay must be initialized by calling checkout.GooglePay',
...
const ERRORS = [
  ...
  {
    code: 'not-configured',
    message: 'Not configured. You must first call checkout.configure().',
    classification: 'merchant',
  ...
  {
    code: 'invalid-item',
    message: 'The given item does not appear to be a valid checkout plan, coupon, addon, or taxable address.',
    classification: 'merchant'
  },
  {
    code: 'invalid-addon',
  ...
  },
  {
    ...
    message: 'Apple Pay must be initialized by calling checkout.ApplePay',
    classification: 'merchant'
  },
  {
  ...
  },
  {
    ...
    message: 'PayPal must be initialized by calling checkout.PayPal',
    classification: 'merchant'
  },
  {
    code: 'venmo-factory-only',
    message: 'Venmo must be initialized by calling checkout.Venmo',
    classification: 'merchant'
  },
  {
  ...
  {
    code: 'paypal-tokenize-checkout-error',
    message: 'An error occurred while attempting to generate the Checkout token',
    classification: 'internal'
  },
  {
  ...
  {
    code: 'paypal-complete-init-error',
    message: 'PayPal encountered an issue while initializing',
    classification: 'merchant'
  },
  {
  ...
  {
    code: 'venmo-braintree-tokenize-checkout-error',
    message: 'An error occurred while attempting to generate the Braintree token within Checkout',
    classification: 'internal'
  },
  {
  ...
  {
    code: 'paypal-braintree-tokenize-checkout-error',
    message: 'An error occurred while attempting to generate the Braintree token within Checkout',
    classification: 'internal'
  },
  {
  ...
  },
  {
    ...
    message: c => `checkout.Risk timeout out in preflight procedure for ${c.processor}. Skipping.`,
    classification: 'internal'
  },
  {
...
class ErrorDirectory {
  constructor () {
    this.ERROR_MAP = ERRORS.reduce((memo, definition) => {
      memo[definition.code] = checkoutErrorFactory(definition);
      return memo;
    }, {});
  }
...
/**
 * Generates a function which binds error properties to a CheckoutError
 *
 * @param {Object} definition
 * @return {Function}
 */
function checkoutErrorFactory (definition) {
  const { code, message, help } = definition;

  /**
   * Checkout domain-specific error class
   *
   ...
   */
  function CheckoutError (context = {}, { reporter } = {}) {
  ...
  CheckoutError.prototype = new Error();
  return CheckoutError;
}
