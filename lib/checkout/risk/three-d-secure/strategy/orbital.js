...
const debug = require('debug')('checkout:risk:three-d-secure:orbital');

export default class OrbitalStrategy extends ThreeDSecureStrategy {
  static strategyName = 'orbital';
