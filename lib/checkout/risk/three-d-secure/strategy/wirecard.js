...
const debug = require('debug')('checkout:risk:three-d-secure:wirecard');
...
export default class WirecardStrategy extends ThreeDSecureStrategy {
  ...
  attach (element) {
    ...
    this.frame = checkout.Frame({ path: '/three_d_secure/start', payload, container, type: Frame.TYPES.IFRAME })
