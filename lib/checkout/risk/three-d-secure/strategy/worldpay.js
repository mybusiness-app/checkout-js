...
const debug = require('debug')('checkout:risk:three-d-secure:worldpay');
...
export default class WorldpayStrategy extends ThreeDSecureStrategy {
   ...
   * @return {Promise}
   */
  static preflight ({ checkout, number = '', jwt, deviceDataCollectionUrl }) {
    ...
    const frame = checkout.Frame({
      ...
      payload: {
        ...
        billing_info_id: preflightDeviceDataCollector.billingInfoId
      },
