...
var DECLINED_TAX_IDENTIFIER_TYPE = 'Tax identifier type must be one of the following: ["cpf", "cnpj", "cuit"]';
...
module.exports = function token () {
  ...
  if (params.tax_identifier_type && !~['cpf','cnpj' ,'cuit'].indexOf(params.tax_identifier_type)) return invalidTaxIdentifierType;
  else return ok;
};
