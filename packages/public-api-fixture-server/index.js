...
app.use(route.post('/paypal_complete/id_tokens', json));
app.use(route.post('/paypal_complete/setup_tokens', json));
app.use(route.post('/paypal_complete/billing_tokens', json));
