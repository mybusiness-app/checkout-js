  ...
  describe('start', () => {
    ...
    context('when RA responds with Adyen', () => {
      ...
      it('load the js and css libraries', done => {
        ...
        paymentMethods.start()
          .finally(() => assertDone(done, () => {
            assert.equal(dom.loadScript.getCall(0).args[0], 'https://checkoutshopper-live.adyen.com/checkoutshopper/sdk/5.65.0/adyen.js');
            assert.equal(dom.loadStyle.getCall(0).args[0], 'https://checkoutshopper-live.adyen.com/checkoutshopper/sdk/5.65.0/adyen.css');
          }));
      });
